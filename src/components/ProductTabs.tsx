          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="space-y-3 text-muted-foreground">
                <p>
                  Each piece is individually handcrafted using premium resin and natural materials, 
                  creating a unique work of art that captures the beauty of geological formations.
                </p>
                <p>
                  Our artisans carefully select pigments and additives to achieve stunning visual 
                  effects that mimic the natural patterns found in geodes and crystals.
                </p>
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2 text-muted-foreground">
                  ...
                  <p><strong>Packaging:</strong> Secure protective packaging to prevent damage</p>
