      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Discover our handcrafted resin art pieces, available in multiple sizes and custom options
          </p>
        </div>
        ...
        <div className="md:hidden overflow-x-auto pb-4">
          <div className="flex space-x-6 px-4">
            {products.map((product) => (
              <Card key={product.id} className="group hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 flex-shrink-0 w-72">
                <CardContent className="p-0">
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-sm text-gray-500 mb-1">{product.defaultSize}</p>
                    <p className="text-lg font-semibold text-purple-600 mb-4">Starting at {product.startingPrice}</p>
